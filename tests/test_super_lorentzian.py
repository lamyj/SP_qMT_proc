...
class TestSuperLorentzian(unittest.TestCase):
    def test_integrand(self):
        ...
        v1 = jsp_qmt._jsp_qmt.super_lorentzian_integrand(x, T2r, delta_f)
        v2 = (
    ...
    def test_integral_scalar(self):
        ...
        v1 = jsp_qmt._jsp_qmt.super_lorentzian(T2r, delta_f)
        v2 = scipy.integrate.quad(
            lambda x: (
                numpy.sqrt(2/numpy.pi)
                * jsp_qmt._jsp_qmt.super_lorentzian_integrand(x, T2r, delta_f)),
            0., 1.)[0]
    ...
    def test_integral_array(self):
        ...
        v1 = jsp_qmt._jsp_qmt.super_lorentzian(T2r, delta_f_array)
        v2 = [
